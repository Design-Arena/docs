...
<CardGroup cols={2}>
  <Card title="List Arenas" icon="layer-group" href="/api-reference/arenas">
    Discover all available arenas and categories
  </Card>
  <Card title="Get Leaderboard" icon="chart-bar" href="/api-reference/leaderboard">
    Full reference for the leaderboard endpoint
  </Card>
  <Card title="Apply for Access" icon="key" href="https://designarena.ai/developers/apply">
    Get your API key
  </Card>
  <Card title="View API Overview" icon="book" href="/api-reference/overview">
    Authentication, caching, and error codes
  </Card>
</CardGroup>
